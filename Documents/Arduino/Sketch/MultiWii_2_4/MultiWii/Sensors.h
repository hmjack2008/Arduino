...
void i2c_read_reg_to_buf(uint8_t add, uint8_t reg, uint8_t *buf, uint8_t size);
  ...
  #define ACC_1G 1024 // 0.000122 g/LSB = 8196.72 LSG/g
#endif
...
#if defined(LSM9DS1) // hmjack2003
  //#define GYRO_SCALE (0.00875 * PI / 180) // Angular rate FS = ±245 dps  8.75 mdps/LSB
  //#define GYRO_SCALE (4 / 114.2857 * PI / 180.0 / 1000000.0) //114.2857 LSB = 1 deg/s
  #define GYRO_SCALE (1 / (1000/70.0) * PI / 180.0 / 1000000.0) //70 mdps/LSB , Gyroscope:+/-2000 dps  ODR:238Hz BW:14Hz
#endif
