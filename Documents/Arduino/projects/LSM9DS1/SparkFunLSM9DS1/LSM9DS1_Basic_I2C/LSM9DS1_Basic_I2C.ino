...
#define DECLINATION -4.5 // Declination (degrees) in Shanghai China. 4'26'(W) 
...
void setup() 
{
  ...
  if (!imu.begin())
  {
    ...
    Serial.println("calibrate  Gyroscope and Accelerometer ... ");
    delay(100);
    imu.calibrate(true);
    delay(100);
    Serial.println("calibrate  Gyroscope and Accelerometer , done ! ");
    delay(100);
    ...
    delay(100);
    Serial.println("calibrate  Magnetometer , done ! ");
    delay(100);
