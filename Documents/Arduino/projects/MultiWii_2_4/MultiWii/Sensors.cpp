...
void Gyro_getADC () {
  ...
  GYRO_ORIENTATION( ((rawADC[1]<<8) | rawADC[0]) ,  // OUT_X_L_G (0x18), OUT_X_H_G (0x19)
				    ((rawADC[3]<<8) | rawADC[2]) ,  // OUT_X_L_G (0x1A), OUT_X_H_G (0x1B)
				    ((rawADC[5]<<8) | rawADC[4]) ); // OUT_X_L_G (0x1C), OUT_X_H_G (0x1D)
  GYRO_Common();
}
...
void ACC_getADC () {
  ...
  ACC_ORIENTATION( ((rawADC[1]<<8) | rawADC[0])>>3 ,  // OUT_X_L_XL (0x28), OUT_X_L_XL (0x29)
				   ((rawADC[3]<<8) | rawADC[2])>>3 ,  // OUT_X_L_XL (0x2A), OUT_X_L_XL (0x2B)
				   ((rawADC[5]<<8) | rawADC[4])>>3 ); // OUT_X_L_XL (0x2C), OUT_X_L_XL (0x2D)
  ACC_Common();
}
